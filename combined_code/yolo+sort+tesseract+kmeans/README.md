...
- track.py is the run file, input video path is given in the parser arguments
- initiate_track function has the most of code we will be editing
- run/tracks folder contans the cropped images of each vehicle under corresponding class
