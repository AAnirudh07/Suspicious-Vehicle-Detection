...
def detect(opt):
    out_video = skvideo.io.FFmpegWriter('output.mp4',{"-pix_fmt":"bgr24"},{"-q":"0", "-color_primaries": "3", "-color_trc": "1", "-colorspace": "1"})
    ...
    # Print results
    t = tuple(x / (seen+1) * 1E3 for x in dt)
    print("len:",len(dataset))  # speeds per image
